...
def draw_comparison(img_a, img_b, boxes_a, boxes_b, new_buildings, save_path, version):
    ...
    cv2.putText(canvas, f"[{version}] Period A", (10, 25), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 255, 0), 2)
    cv2.putText(canvas, f"[{version}] Period B", (w + 10, 25), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 255, 0), 2)
    for ba in boxes_a:
